	    ...
	    float angle=0;
	     ...
	     env.add_leg_object(i,*l1);
            ...
            s1->set_lim(0, -M_PI/8, M_PI/8 );
             ...
             Object::ptr_t l2(
                 new CappedCyl(env, pos +
                               Eigen::Vector3d(xStart+sin(angle) * (legP1_length+legP2_length/2),
	     ...
	     env.add_leg_object(i,*l2);
             ...
             Mx28::ptr_t s2(new Mx28(env, pos +
				     Eigen::Vector3d(xStart+sin(angle) * (legP1_length),
            ...
            s2->set_lim(0, -M_PI/4, M_PI/4 );
             ...
             Object::ptr_t l3(
                 new CappedCyl(env, pos +
                               Eigen::Vector3d(xStart+sin(angle) * (legP1_length+legP2_length),
